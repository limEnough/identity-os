...
const QUESTIONS: Record<string, string> = {
  vivid: '쉬는 날, 각자 어떻게 힘을 되찾는지 서로 물어보세요.',
  sharp: '의견이 갈릴 때 무엇을 먼저 지키려 하는지 서로 물어보세요.',
  modern:
...
const BLINDSPOTS: Record<string, string> = {
  vivid: '둘 다 같은 속도라, 다른 속도의 사람과 있을 때를 서로 이야기해보세요.',
  sharp: '둘 다 같은 방식이라, 그 방식이 통하지 않았던 때를 서로 꺼내보세요.',
