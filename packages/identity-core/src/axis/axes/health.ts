...
const OPENINGS: AxisOpening[] = [
  {
    ...
    children: [
      ...
      {
        title: "물이나 커피를 먼저 마신다",
        label: "먼저 마심",
        shift: [-0.2, 0.3, -0.1],
      },
      {
        title: "몸이 무거운지 먼저 살핀다",
        label: "무거운지 살핌",
        shift: [-0.5, 0.2, -0.6],
      },
    ],
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: "땀이 날 만큼만 가볍게 한다",
        label: "가볍게 함",
        shift: [0.4, -0.5, -0.1],
      },
      {
        title: "사람들과 함께 뛰거나 겨룬다",
        label: "함께 뛰거나 겨룸",
        shift: [0.8, 0.4, 0.9],
      },
      {
    ...
    scoped: [
      ...
      {
        title: "몸이 눈에 보이게 달라질 때",
        label: "몸이 달라질 때",
        phrase: "몸이 달라지던 무렵",
        shift: [0.6, 0.6, 0.4],
      },
      {
        title: "한동안 쉬었다 다시 시작할 때",
        label: "다시 시작할 때",
        phrase: "다시 시작하던 자리",
        shift: [0.3, 0.3, -0.1],
      },
  ...
  },
  {
    ...
    children: [
      {
        title: "정해둔 순서로 하루를 닫는다",
        label: "정해둔 순서로 닫음",
        shift: [-0.5, 0.8, -0.4],
      },
      {
        title: "화면을 보다 그대로 잠든다",
        label: "보다 잠듦",
        shift: [-0.3, -0.7, -0.3],
      },
      {
...
const OUTCOMES: AxisOutcome[] = [
  {
    ...
    facets: [
      {
        name: "몸을 되돌리는 법",
        chips: ["일찍 눕기", "느린 산책", "따뜻한 물", "아무것도 안 하기"],
      },
      {
        name: "먹는 것",
        chips: ["익숙한 것", "따뜻한 국물", "차", "조금씩"],
      },
      {
        name: "쉬는 자리",
        chips: ["어두운 방", "이불 속", "창가", "조용한 집"],
      },
      {
        name: "무너질 때",
        chips: ["멈추고 눕기", "연락 미루기", "하루 비우기", "혼자 있기"],
      },
    ],
    variants: [
      "혼자 조용히",
  ...
  },
  {
    ...
    facets: [
      {
        name: "몸을 되돌리는 법",
        chips: ["같이 걷기", "수다", "함께 먹기", "남의 집에서 쉬기"],
      },
      {
        name: "먹는 것",
        chips: ["같이 차린 밥", "나눠 먹는 것", "느긋한 식사", "따뜻한 음료"],
      },
      {
        name: "쉬는 자리",
        chips: ["식탁", "거실", "동네 산책길", "카페"],
      },
      {
        name: "무너질 때",
        chips: ["털어놓기", "같이 있어 달라 하기", "도움 청하기", "함께 쉬기"],
      },
    ],
    variants: [
      "함께 있는 쪽으로",
  ...
  },
  {
    ...
    facets: [
      ...
      {
        name: "먹는 것",
        chips: ["정해둔 끼니", "단순한 식단", "물 챙기기", "같은 아침"],
      },
      {
        name: "쉬는 자리",
        chips: ["정돈된 방", "어두운 침실", "같은 산책길", "정해둔 시간대"],
      },
      {
        name: "무너질 때",
        chips: [
  ...
  },
  {
    ...
    facets: [
      {
        name: "몸을 되돌리는 법",
        chips: ["같이 하는 운동", "약속한 시간", "서로 확인", "기록 공유"],
      },
      {
        name: "먹는 것",
        chips: [
      ...
      {
        name: "쉬는 자리",
        chips: ["정해진 체육관", "같은 코스", "함께 가는 병원", "주말 아침"],
      },
      {
        name: "무너질 때",
        chips: ["먼저 알리기", "도움 요청", "약속 조정", "함께 다시 시작"],
      },
    ],
    variants: [
      "약속으로 지키며",
  ...
  },
  {
    ...
    facets: [
      {
        name: "몸을 되돌리는 법",
        chips: ["오래 걷기", "자전거", "가벼운 요가", "계단"],
      },
      {
        name: "먹는 것",
        chips: ["간단하게", "가벼운 것", "물 많이", "움직인 뒤 한 끼"],
      },
      {
        name: "쉬는 자리",
        chips: ["동네 길", "강변", "공원", "햇볕 드는 곳"],
      },
      {
        name: "무너질 때",
        chips: ["그래도 걷기", "거리를 줄이기", "느리게", "밖에 나가기"],
      },
    ],
    variants: [
      "가볍게 움직이며",
  ...
  },
  {
    ...
    facets: [
      {
        name: "몸을 되돌리는 법",
        chips: ["무게 늘리기", "주기 지키기", "기록 남기기", "자세 다듬기"],
      },
      {
        name: "먹는 것",
        chips: ["단백질", "정해둔 양", "시간 맞춰", "군더더기 없이"],
      },
      {
        name: "쉬는 자리",
        chips: ["같은 체육관", "집의 매트", "이른 아침", "혼자의 시간"],
      },
      {
        name: "무너질 때",
        chips: [
  ...
  },
  {
    ...
    facets: [
      {
        name: "몸을 되돌리는 법",
        chips: ["대회·기록 도전", "함께 훈련", "코치와 함께", "경쟁"],
      },
      {
        name: "먹는 것",
        chips: ["계획된 식단", "보충제", "경기 전 루틴", "함께 관리"],
      },
      {
        name: "쉬는 자리",
        chips: ["운동장", "팀 훈련장", "대회장", "사람 많은 시간대"],
      },
      {
        name: "무너질 때",
        chips: ["팀에 알리기", "목표 조정", "함께 회복", "다시 등록하기"],
      },
    ],
    variants: [
      "겨루며 밀고",
