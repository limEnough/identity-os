...
const OUTCOMES: AxisOutcome[] = [
  {
    ...
    facets: [
      { icon: 'chat', name: '자주 하는 말', chips: ['"뭔가 좀…"', '"느낌이 그래요"', '천천히 꺼내는 말', '침묵을 견디는 편'] },
      { icon: 'window', name: '생각이 잘 되는 곳', chips: ['혼자 있는 방', '늦은 밤', '창가', '걷는 길'] },
      { icon: 'coat', name: '정할 때 하는 일', chips: ['서두르지 않기', '몸의 반응 보기', '하루 재워두기', '마음이 편한 쪽'] },
      { icon: 'box', name: '막혔을 때 하는 일', chips: ['일단 덮어두기', '멀리 보기', '조용한 산책', '메모 한 줄'] },
    ],
    variants: [
      '혼자 있을 때 특히 잘 나와요',
      '조용한 자리에서 더 선명해져요',
  ...
  },
  {
    ...
    facets: [
      { icon: 'chat', name: '자주 하는 말', chips: ['"그럴 수 있죠"', '"괜찮아요?"', '되묻는 질문', '부드러운 끝말'] },
      { icon: 'window', name: '생각이 잘 되는 곳', chips: ['둘이 마주 앉은 자리', '대화 중간', '함께 걷는 길', '남의 이야기 속'] },
      { icon: 'coat', name: '정할 때 하는 일', chips: ['누가 힘들어질지 보기', '함께 정하기', '조율하기', '급하지 않게'] },
      { icon: 'box', name: '막혔을 때 하는 일', chips: ['사람에게 묻기', '털어놓기', '같이 있어 보기', '기대 낮추기'] },
    ],
    variants: [
      '사람이 걸린 일에서 특히 잘 나와요',
      '대화 중에 생각이 정리돼요',
  ...
  },
  {
    ...
    facets: [
      { icon: 'chat', name: '자주 하는 말', chips: ['"정리하면요"', '"그러니까 결국"', '군더더기 없는 말', '조용한 결론'] },
      { icon: 'window', name: '생각이 잘 되는 곳', chips: ['책상 앞', '이른 아침', '비어 있는 노트', '조용한 카페'] },
      { icon: 'coat', name: '정할 때 하는 일', chips: ['기준을 먼저 적기', '항목으로 나누기', '지워가기', '한 번 더 확인'] },
      { icon: 'box', name: '막혔을 때 하는 일', chips: ['목록으로 쪼개기', '가장 작은 것부터', '순서 다시 짜기', '남에게 설명해 보기'] },
    ],
    variants: [
      '적어놓고 볼 때 특히 잘 나와요',
  ...
  },
  {
    ...
    facets: [
      { icon: 'chat', name: '자주 하는 말', chips: ['"이유는 셋이에요"', '"정확히 말하면"', '또렷한 발음', '결론 먼저'] },
      { icon: 'window', name: '생각이 잘 되는 곳', chips: ['화이트보드 앞', '회의 자리', '누군가에게 말하는 중', '글 쓰는 창'] },
      { icon: 'coat', name: '정할 때 하는 일', chips: ['근거를 갖추기', '반박을 미리 그리기', '기록으로 남기기', '분명히 말하기'] },
      { icon: 'box', name: '막혔을 때 하는 일', chips: ['남에게 설명하기', '구조를 그리기', '용어를 정의하기', '반대 입장 써보기'] },
    ],
    variants: [
  ...
  },
  {
    ...
    facets: [
      { icon: 'chat', name: '자주 하는 말', chips: ['"갑자기 생각났는데"', '"이거랑 비슷한데"', '자꾸 번지는 말', '비유가 많은 편'] },
      { icon: 'window', name: '생각이 잘 되는 곳', chips: ['버스 창가', '샤워 중', '낯선 동네', '음악 속'] },
      { icon: 'coat', name: '정할 때 하는 일', chips: ['여러 갈래 그려보기', '재미있는 쪽 보기', '여지를 남기기', '너무 좁히지 않기'] },
      { icon: 'box', name: '막혔을 때 하는 일', chips: ['다른 일로 옮기기', '엉뚱한 것 붙여보기', '산책', '아무렇게나 써보기'] },
    ],
    variants: [
      '몸을 움직일 때 특히 잘 나와요',
      '낯선 곳에서 더 활발해져요',
  ...
  },
  {
    ...
    facets: [
      { icon: 'chat', name: '자주 하는 말', chips: ['"해보면 알죠"', '"일단 한번"', '가벼운 제안', '실패를 웃으며'] },
      { icon: 'window', name: '생각이 잘 되는 곳', chips: ['만드는 책상', '사람들 사이', '새로 가본 곳', '해보는 중'] },
      { icon: 'coat', name: '정할 때 하는 일', chips: ['작게 먼저 해보기', '되돌릴 수 있게', '빨리 확인하기', '틀려도 괜찮게'] },
      { icon: 'box', name: '막혔을 때 하는 일', chips: ['다른 방법 하나 더', '남에게 보여주기', '규모 줄이기', '오늘 안에 시도'] },
    ],
    variants: [
  ...
  },
  {
    ...
    facets: [
      { icon: 'chat', name: '자주 하는 말', chips: ['"근데 왜요?"', '"끝까지 보면"', '되묻는 말', '자세한 설명'] },
      { icon: 'window', name: '생각이 잘 되는 곳', chips: ['자료 더미 앞', '늦은 밤 작업실', '한 권을 다 읽는 자리', '기록해 둔 노트'] },
      { icon: 'coat', name: '정할 때 하는 일', chips: ['끝까지 알아보기', '근거를 모으기', '예외를 확인하기', '충분히 파고 결정'] },
      { icon: 'box', name: '막혔을 때 하는 일', chips: ['처음으로 돌아가기', '원문 찾기', '작게 쪼개 검증', '기록 다시 읽기'] },
    ],
    variants: [
      '방해가 없을 때 특히 잘 나와요',
      '밤에 더 깊이 들어가요',
  ...
  },
  {
    ...
    facets: [
      { icon: 'chat', name: '자주 하는 말', chips: ['"이렇게 갑시다"', '"지금 정하죠"', '짧은 결론', '망설임 없는 어조'] },
      { icon: 'window', name: '생각이 잘 되는 곳', chips: ['움직이는 중', '급한 자리', '사람들 앞', '마감 직전'] },
      { icon: 'coat', name: '정할 때 하는 일', chips: ['7할이면 정하기', '먼저 정하고 보정', '되돌릴 여지 남기기', '분명히 알리기'] },
      { icon: 'box', name: '막혔을 때 하는 일', chips: ['일단 정해보기', '기한을 세우기', '한 사람에게 확인', '작게 실행'] },
    ],
    variants: [
      '시간이 없을 때 특히 잘 나와요',
      '사람들 앞에서 더 분명해져요',
