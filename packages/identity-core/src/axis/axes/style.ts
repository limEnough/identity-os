...
const facets = (
  ...
  { name: "옷차림", chips: wear },
  { name: "공간", chips: space },
  { name: "말과 태도", chips: words },
  { name: "곁에 두는 것", chips: things },
];
...
const OUTCOMES: AxisOutcome[] = [
  ...
  },
  {
    ...
    variants: ["비워둔 쪽으로", "맑은 쪽으로", "덜어내며", "여백을 남기며", "소리를 낮추며", "텅 빈 쪽으로"],
  },
  {
    name: "단정한 기품",
    alt: "고요한 격식",
  ...
  },
  {
    ...
    variants: ["가벼운 쪽으로", "둥글게", "지금의 생기로", "말랑한 쪽으로", "말갛게 밝은 쪽으로", "포근한 생기로"],
  },
  {
    name: "단단한 생동",
    alt: "곧은 활기",
    ...
    imprint: canon(0.5, 0.5, -0.6, 0.4),
    fits: ["손으로 하는 일", "믿음직해 보여야 하는 자리", "몸을 쓰는 자리"],
    strains: [
      "섬세함이 요구되는 자리",
      "부드럽게 다가가야 할 때",
      "투박하다는 말을 들을 때",
